...
namespace BlueNet.Api
{
    public class Startup
    {
        ...
        {
            //AdđbContext
            services.AddDbContext<BlueNetDbContext>(options =>
            {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "BlueNet.Api", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "BlueNet.Api v1"));
            }
